...
function Login() {
  ...
  return (
    <div className="bg-cust-grey-100 h-screen w-screen flex justify-center items-center gap-2">
      <div className="bg-cust-grey-0 px-4 py-8 w-4/5 rounded-2xl flex flex-col justify-center items-center gap-4 shadow-lg">
        <Logo
          className="flex-col text-blue-800"
          header="text-4xl text-blue-[#1e40af]"
          isLogin={true}
        />
        ...
        >
          ...
          <div className="flex flex-col gap-2 ">
            <button
              className="bg-blue-500 py-2 px-4 rounded-md text-white uppercase font-bold tracking-wider hover:bg-blue-700 transition-all duration-100 disabled:opacity-25"
              disabled={isLoading}
            >
